...
_K.EXT_EMO_MASKS = 'EXT_EMO_MASKS'
...
_K.G_EMOTION_IDS = 'G_EMOTION_IDS'

_K.G_EMO_TYPE = 'G_EMO_TYPE'

_K.G_EMO_WORD_IDS = 'G_EMO_WORD_IDS'

_K.G_EMO_WORD_EMBED = 'G_EMO_WORD_EMBED'

_K.G_ATTR_IDS = 'G_ATTR_IDS'

_K.G_ATTR_EMBED = 'G_ATTR_EMBED'

_K.G_EMO_LABEL = 'G_EMO_LABEL'

_K.ATTR_MASK = 'ATTR_MASK'

_K.EXT_ATTR_MASK = 'EXT_ATTR_MASK'

_K.ENCODER_TOKEN = 'ENCODER_TOKEN'

_K.TOKEN_EMBED = 'TOKEN_EMBED'

_K.ATTR_PRED = 'ATTR_PRED'

_K.ATTR_PRED_IDS = 'ATTR_PRED_IDS'

_K.ART_STYLE = 'ART_STYLE'

_K.G_CONCEPTS_IDS = 'G_CONCEPTS_IDS'

_K.CLIP_PRED = 'CLIP_PRED'

_K.CONCEPTS_PRED = 'CONCEPTS_PRED'

_K.CONCEPTS_PRED_IDS = 'CONCEPTS_PRED_IDS'

_K.CONCEPTS_LABEL = 'CONCEPTS_LABEL'

_K.PRED_EMBED = 'PRED_EMBED'
